...
#
# Commands:
#   hubot (search|forum)( me) <query> - returns URL's and Title's for 5 first results from custom search in *.kerbalspaceprogram.com
#
# Notes:
...
module.exports = (robot) ->
  robot.respond /(search|forum)( me)? (.*)/i, (msg) ->
    msg
